...
export default function Profile() {
  ...
  const [deliveryAddress, setDeliveryAddress] = useState(userDetails?.deliveryAddress || '');
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        ...
        >
              ...
              {isEditing && (
                <tr>
                  <td colSpan={2} style={{ textAlign: 'center', paddingTop: '10px' }}>
                    ...
                    <button type="button" className="btn btn-sm" onClick={handleCancel} style={{ marginLeft: '10px', background: '#CBD5E0' }}>
                      Cancel
                    </button>
                  </td>
                </tr>
          ...
          <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-evenly', padding: '10px', marginTop: '10px' }}>
            <div onClick={handleOrders} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', cursor: 'pointer' }}>
              <PiPackageFill style={{ width: '30px', height: '30px', color: '#2874f0' }} />
              <div style={{ fontWeight: 'bolder', fontSize: '12px' }}>My Orders</div>
            </div>
            <div onClick={handleWishlist} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', cursor: 'pointer' }}>
              <FaHeart style={{ width: '30px', height: '30px', color: 'red' }} />
              <div style={{ fontWeight: 'bolder', fontSize: '12px' }}>Wish List</div>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', cursor: 'pointer' }}>
              <HiOutlinePencilAlt style={{ cursor: 'pointer', color: '#2874f0', width: '30px', height: '30px' }} onClick={() => setIsEditing(true)} />
